...
export const useMessageTypeStore = defineStore('messageType', () => {
  ...
  const mockMessageTypes = [
    { id: 1, name: 'System Notification', color: '#409EFF', icon: 'Bell' },
    { id: 2, name: 'Work Reminder', color: '#67C23A', icon: 'Notification' },
    { id: 3, name: 'Alert Information', color: '#F56C6C', icon: 'Warning' },
    { id: 4, name: 'Meeting Notification', color: '#E6A23C', icon: 'Calendar' },
    { id: 5, name: 'Operational Activity', color: '#909399', icon: 'Promotion' },
    { id: 6, name: 'Typhoon Notification', color: '#F56C6C', icon: 'Warning' }
  ]
