  ...
  <el-container class="layout-container">
    ...
    <el-aside :width="isCollapse ? '64px' : '200px'" class="sidebar-container">
      <div class="logo-container">
        ...
        <span v-show="!isCollapse">Notification System</span>
      </div>
    ...
    <el-container class="main-container">
          ...
          <el-dropdown trigger="click">
            ...
            <template #dropdown>
              <el-dropdown-menu>
                ...
                <el-dropdown-item divided @click="router.push('/login')">Logout</el-dropdown-item>
              </el-dropdown-menu>
            </template>
          </el-dropdown>
        </div>
      ...
      <el-footer class="footer-container">
        <div>© 2025 PQMAP Notification System</div>
      </el-footer>
    </el-container>
  </el-container>
</template>
