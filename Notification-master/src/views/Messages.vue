  ...
  <div class="messages-container">
    ...
    <el-card shadow="hover" class="filter-card">
      <el-row :gutter="20">
        ...
        <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6">
          <el-select v-model="activeType" placeholder="Type" class="filter-select">
        ...
        <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6">
          <el-select v-model="activeStatus" placeholder="Status" class="filter-select">
    ...
    <el-card shadow="hover" class="message-list-card">
      ...
      >
        ...
        <el-table-column label="Importance" width="80" align="center">
          <template #default="{ row }">
