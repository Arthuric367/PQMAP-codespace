...
<template>
  <div class="message-detail-container" v-loading="loading">
    ...
    <el-card v-if="message" shadow="hover" class="message-card">
      <div class="message-header">
        ...
        <div class="message-meta">
          ...
          <span class="sender">Sender：{{ message.sender }}</span>
          <span class="time">Send Time：{{ message.sendTime }}</span>
        </div>
      </div>
    ...
    <el-empty v-else description="The message does not exist or has been deleted."></el-empty>
  </div>
</template>
