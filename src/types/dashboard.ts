...
export const DEFAULT_LAYOUTS: Record<string, DashboardLayout> = {
  admin: {
    ...
    widgets: [
      ...
      { id: 'insight-chart', col: 0, row: 5, width: 12, visible: true },
      { id: 'affected-customer-chart', col: 0, row: 6, width: 12, visible: true },
      { id: 'affected-equipment-chart', col: 0, row: 7, width: 6, visible: true },
      { id: 'event-list', col: 0, row: 8, width: 12, visible: true },
      { id: 'sarfi-70-monitor', col: 0, row: 9, width: 12, visible: true },
    ],
  },
  operator: {
    version: '1.0',
    widgets: [
      ...
      { id: 'affected-equipment-chart', col: 0, row: 7, width: 6, visible: true },
      { id: 'event-list', col: 0, row: 8, width: 12, visible: true },
      { id: 'sarfi-70-monitor', col: 0, row: 9, width: 12, visible: false },
    ],
  },
  viewer: {
    version: '1.0',
    widgets: [
      ...
      { id: 'insight-chart', col: 0, row: 5, width: 12, visible: false },
      { id: 'affected-customer-chart', col: 0, row: 6, width: 12, visible: true },
      { id: 'affected-equipment-chart', col: 0, row: 7, width: 6, visible: false },
      { id: 'event-list', col: 0, row: 8, width: 12, visible: true },
      { id: 'sarfi-70-monitor', col: 0, row: 9, width: 12, visible: false },
    ],
  },
